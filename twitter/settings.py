...
SECRET_KEY = 'li^^5m0*k8sb@le51s@xi1=zq4q+y!5zz8_v%=(v!0-t@-o6-i'
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-wutianqi'
...
# DO NOT pip install memcache or django-memcached 已经过期了
CACHES = {
    'default': {
